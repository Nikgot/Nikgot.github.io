...
function ipLoc(){
	return fetch(`https://salmon-sand-33e16d8013fe494cacae98bae9701b7e.azurewebsites.net/api/location`)
...
function geoLoc(){
	...
	return fetch(`https://salmon-sand-33e16d8013fe494cacae98bae9701b7e.azurewebsites.net/api/geocode?address=${encodeURIComponent(address)}`)
		.then(response => response.json())
		.then(data => {
			if(data.error){
...
document.getElementById("g_info").addEventListener("click", function generalInfo() {
	...
	getLocation()
		.then(() => {
			//console.log("lat", lat);
			fetch(`https://salmon-sand-33e16d8013fe494cacae98bae9701b7e.azurewebsites.net/weather?lat=${lat}&lng=${lng}`)
				.then(response => response.json())
				.then(data => {
					//console.log("lat", lat);
					w = data;
			...
			.then(() =>{
				...
				fetch(`https://salmon-sand-33e16d8013fe494cacae98bae9701b7e.azurewebsites.net/weather2?lat=${lat}&lng=${lng}`)
				.then(response => response.json())
				.then(data => {
					//console.log("lat", lat);
					w2 = data;
